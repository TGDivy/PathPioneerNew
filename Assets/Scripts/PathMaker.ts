...
export class PathMaker extends BaseScriptComponent {
    ...
    protected storage: GeneralDataStore;
    ...
    protected finishLoop(startObject: SceneObject,
        ...
        this.storage.putVec3("savedStartPosition", startPosition);
        this.storage.putQuat("savedStartRotation", startRotation);
        this.storage.putVec3Array("savedSplinePointPositions", splinePoints.map(p => p.position));
        this.storage.putQuatArray("savedSplinePointRotations", splinePoints.map(p => p.rotation));
        print("saving the following values (finishLoop)");
        print(startPosition);
        print(startRotation);
        print(splinePoints);
    ...
    private finishSprint(startObject: SceneObject,
        ...
        this.storage.putVec3Array("savedSplinePointPositions", splinePoints.map(p => p.position));
        this.storage.putQuatArray("savedSplinePointRotations", splinePoints.map(p => p.rotation));
        print("saving the following values (finishSprint)");
        print(startPosition);
        print(startRotation);
        print(splinePoints);
