...
export class LensInitializer extends BaseScriptComponent {
    ...
    private startHomeState() {
        ...
        const savedSplinePointPositions = store.getVec3Array("savedSplinePointPositions");
        ...
        if (savedSplinePointPositions.length === 0) {
            ...
            const savedSplinePointPositions = store.getVec3Array("savedSplinePointPositions");
            const savedSplinePointRotations = store.getQuatArray("savedSplinePointRotations");

            print("hello from the script (startHomeState), the following values were loaded")
